package com.yuki.zhangyue.module.main.bookcase.search;
...
public class BookcaseSortSpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            textView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, AppKit.dp2px(mContext, 40)));
            textView.setPadding(AppKit.dp2px(mContext, 8), 0, AppKit.dp2px(mContext, 40), 0);
