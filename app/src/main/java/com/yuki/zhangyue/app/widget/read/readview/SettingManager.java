...
import com.yuki.zhangyue.app.common.CommonKt;
import com.yuki.zhangyue.app.widget.read.readview.utils.SharedPreferencesUtil;
...
public class SettingManager {
    ...
    public int getReadFontSize(String bookId) {
        return SharedPreferencesUtil.getInstance().getInt(getFontSizeKey(bookId), AppKit.dp2px(16));
    }
    ...
    public int getReadTheme() {
        if (SharedPreferencesUtil.getInstance().getBoolean(CommonKt.ISNIGHT, false)) {
