...
public class ThemeManager {
    ...
    public static Bitmap getThemeDrawable(int theme) {
        Bitmap bmp = Bitmap.createBitmap(AppKit.getScreenWidth(), AppKit.getScreenHeight(), Bitmap.Config.ARGB_8888);
        switch (theme) {
            case NORMAL:
                bmp.eraseColor(AppKit.getColor(R.color.read_theme_white));
                break;
            case YELLOW:
                bmp.eraseColor(AppKit.getColor(R.color.read_theme_yellow));
                break;
            case GREEN:
                bmp.eraseColor(AppKit.getColor(R.color.read_theme_green));
                break;
            case GRAY:
                bmp.eraseColor(AppKit.getColor(R.color.read_theme_gray));
                break;
            case NIGHT:
                bmp.eraseColor(AppKit.getColor(R.color.read_theme_night));
                break;
            default:
                break;
        }
