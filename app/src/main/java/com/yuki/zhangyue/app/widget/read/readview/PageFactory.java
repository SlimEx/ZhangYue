 ...
 */
package com.yuki.zhangyue.app.widget.read.readview;
...
import com.yuki.zhangyue.app.entity.BookChapter;
...
public class PageFactory {
    ...
    private List<BookChapter> chaptersList;
    ...
    public PageFactory(Context context, String bookId, List<BookChapter> chaptersList) {
        this(context, AppKit.getScreenWidth(), AppKit.getScreenHeight(),
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
                       List<BookChapter> chaptersList) {
        mContext = context;
        mWidth = width;
        mHeight = height;
        mFontSize = fontSize;
        mLineSpace = mFontSize / 5 * 2;
        mNumFontSize = AppKit.dp2px(16);
        marginWidth = AppKit.dp2px(15);
        marginHeight =AppKit.dp2px(15);
        ...
        mTitlePaint.setColor(ContextCompat.getColor(AppKit.context, R.color.chapter_title_day));
    ...
    public synchronized void onDraw(Canvas canvas) {
        ...
        if (mLines.size() > 0) {
            ...
            // 绘制标题
            canvas.drawText(chaptersList.get(currentChapter - 1).getChapterName(), marginWidth, y, mTitlePaint);
            ...
            if (batteryBitmap != null) {
                canvas.drawBitmap(batteryBitmap, marginWidth + 2,
                        mHeight - marginHeight - AppKit.dp2px(12), mTitlePaint);
            }
    ...
    public void convertBatteryBitmap() {
        ...
        batteryView.measure(View.MeasureSpec.makeMeasureSpec(AppKit.dp2px(26), View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(AppKit.dp2px(14), View.MeasureSpec.EXACTLY));
